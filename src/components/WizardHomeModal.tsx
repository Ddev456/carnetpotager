  ...
  return (
    <Modal showModal={showModal} setShowModal={setShowModal}>
        <div className="h-[90%] rounded-xl shadow-xl flex flex-col items-center px-8 py-8 bg-dark text-grayscale">
                <h3 className='font-extrabold relative'>Assitant potager - Mon potager</h3>
                <p className='font-semibold'>Laissez vous guider par l’assistant pour générer votre potager.</p>
                <SelectionStep />
                <button
                className="text-gray font-bold bg-primary hover:bg-gradient-to-br 
